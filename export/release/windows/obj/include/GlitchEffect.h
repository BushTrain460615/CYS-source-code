...
class HXCPP_CLASS_ATTRIBUTES GlitchEffect_obj : public  ::Effect_obj
{
	public:
	...
	public:
		...
		static ::hx::ObjectPtr< GlitchEffect_obj > __new(Float waveSpeed,Float waveFrequency,Float waveAmplitude);
		static ::hx::ObjectPtr< GlitchEffect_obj > __alloc(::hx::Ctx *_hx_ctx,Float waveSpeed,Float waveFrequency,Float waveAmplitude);
