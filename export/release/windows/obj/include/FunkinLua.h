...
class HXCPP_CLASS_ATTRIBUTES FunkinLua_obj : public ::hx::Object
{
	...
	public:
		...
		bool gonnaClose;
		 ...
		 ::flixel::text::FlxText getTextObject(::String name);
		::Dynamic getTextObject_dyn();
		...
		::Dynamic cameraFromString_dyn();
		 ...
		 ::ChromaticAberrationEffect shaderFromString(::String cam);
		::Dynamic shaderFromString_dyn();
