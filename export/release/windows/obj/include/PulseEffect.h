...
class HXCPP_CLASS_ATTRIBUTES PulseEffect_obj : public  ::Effect_obj
{
	public:
	...
	public:
		...
		static ::hx::ObjectPtr< PulseEffect_obj > __new(Float waveSpeed,Float waveFrequency,Float waveAmplitude);
		static ::hx::ObjectPtr< PulseEffect_obj > __alloc(::hx::Ctx *_hx_ctx,Float waveSpeed,Float waveFrequency,Float waveAmplitude);
