...
class HXCPP_CLASS_ATTRIBUTES ClientPrefs_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String screenRes;
		static ::String screenResTemp;
		static ::String screenScaleMode;
		static ::String screenScaleModeTemp;
		...
		static ::Array< int > getResolution();
		static ::Dynamic getResolution_dyn();
