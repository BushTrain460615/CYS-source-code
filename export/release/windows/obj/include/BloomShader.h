...
class HXCPP_CLASS_ATTRIBUTES BloomShader_obj : public  ::flixel::graphics::tile::FlxGraphicsShader_obj
{
	...
	public:
		enum { _hx_ClassId = 0x55a24468 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="BloomShader")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"BloomShader"); }
