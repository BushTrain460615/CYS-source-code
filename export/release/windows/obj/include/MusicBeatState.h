...
class HXCPP_CLASS_ATTRIBUTES MusicBeatState_obj : public  ::flixel::addons::ui::FlxUIState_obj
{
	...
	public:
		...
		static  ::MusicBeatState musInstance;
		...
		int curBeat;
		Float scaleRatio;
		 ::flixel::_hx_system::scaleModes::RatioScaleMode modeRatio;
		 ::flixel::_hx_system::scaleModes::StageSizeScaleMode modeStage;
