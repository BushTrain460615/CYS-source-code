...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		static ::String othersCodeName;
		 ...
		 ::ChromaticAberrationEffect shader_chromatic_abberation;
		::Array< ::Dynamic> camGameShaders;
		::Array< ::Dynamic> camHUDShaders;
		::Array< ::Dynamic> camOtherShaders;
