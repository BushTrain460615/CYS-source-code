...
class HXCPP_CLASS_ATTRIBUTES Achievements_obj : public ::hx::Object
{
	...
	public:
		...
		static void reloadAchievements();
		static ::Dynamic reloadAchievements_dyn();

		static  ::Dynamic getAchievementInfo(::String path);
		static ::Dynamic getAchievementInfo_dyn();
