...
HXDLIN(  51)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(skin,library);
HXDLIN(  51)		 ::flixel::graphics::FlxGraphic graphic = returnAsset;
...
HXLINE(  51)			_hx_tmp = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE(  51)			_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            		}
HXDLIN(  51)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(graphic,_hx_tmp));
HXLINE(  52)		{
HXLINE(  52)			{
