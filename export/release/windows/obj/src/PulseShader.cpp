...
HX_DEFINE_STACK_FRAME(_hx_pos_6524c27d1753b463_1326_new,"PulseShader","new",0x6ef8e2f0,"PulseShader.new","Shaders.hx",1326,0x469785f0)

void PulseShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6524c27d1753b463_1326_new)
...
HXLINE(1327)		super::__construct();
HXLINE(1277)		this->_hx___isGenerated = true;
HXDLIN(1277)		this->_hx___initGL();
            	}
