...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("PsychEngine",3d,1b,63,8f),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("10",df,2a,00,00));
...
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.shadowmario.psychengine",c6,9e,3e,fb));
HXLINE(  40)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("0.2.7",bd,c1,c9,c1));
