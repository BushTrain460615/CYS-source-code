...
HX_DEFINE_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_1999_new,"DebugLuaText","new",0xad824284,"DebugLuaText.new","FunkinLua.hx",1999,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_2011_update,"DebugLuaText","update",0x3cb60265,"DebugLuaText.update","FunkinLua.hx",2011,0x00117937)

void DebugLuaText_obj::__construct(::String text, ::flixel::group::FlxTypedGroup parentGroup){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_1999_new)
HXLINE(2001)		this->disableTime = ((Float)6);
HXLINE(2004)		this->parentGroup = parentGroup;
HXLINE(2005)		super::__construct(10,10,0,text,16,null());
HXLINE(2006)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(2006)		::String _hx_tmp;
HXDLIN(2006)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(2006)			_hx_tmp = file;
            		}
            		else {
HXLINE(2006)			_hx_tmp = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(2006)		this->setFormat(_hx_tmp,20,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(2007)		this->scrollFactor->set(null(),null());
HXLINE(2008)		this->set_borderSize(( (Float)(1) ));
            	}
...
void DebugLuaText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_2011_update)
HXLINE(2012)		this->super::update(elapsed);
HXLINE(2013)		 ::DebugLuaText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(2013)		_hx_tmp->disableTime = (_hx_tmp->disableTime - elapsed);
HXLINE(2014)		if ((this->disableTime <= 0)) {
HXLINE(2015)			this->kill();
HXLINE(2016)			this->parentGroup->remove(::hx::ObjectPtr<OBJ_>(this),null()).StaticCast<  ::DebugLuaText >();
HXLINE(2017)			this->destroy();
            		}
            		else {
HXLINE(2019)			if ((this->disableTime < 1)) {
HXLINE(2019)				this->set_alpha(this->disableTime);
            			}
            		}
            	}
