...
HX_DEFINE_STACK_FRAME(_hx_pos_f46673645c9c8da3_1191_new,"GlitchShader","new",0x6d622f0c,"GlitchShader.new","Shaders.hx",1191,0x469785f0)

void GlitchShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f46673645c9c8da3_1191_new)
...
HXLINE(1192)		super::__construct();
HXLINE(1147)		this->_hx___isGenerated = true;
HXDLIN(1147)		this->_hx___initGL();
            	}
