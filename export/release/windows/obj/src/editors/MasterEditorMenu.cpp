...
HX_LOCAL_STACK_FRAME(_hx_pos_aa1a162bced268b8_88_update,"editors.MasterEditorMenu","update",0xf951b2e1,"editors.MasterEditorMenu.update","editors/MasterEditorMenu.hx",88,0x3933e087)
HX_LOCAL_STACK_FRAME(_hx_pos_aa1a162bced268b8_154_changeSelection,"editors.MasterEditorMenu","changeSelection",0x385910e4,"editors.MasterEditorMenu.changeSelection","editors/MasterEditorMenu.hx",154,0x3933e087)
HX_LOCAL_STACK_FRAME(_hx_pos_aa1a162bced268b8_167_changeDirectory,"editors.MasterEditorMenu","changeDirectory",0xba830b05,"editors.MasterEditorMenu.changeDirectory","editors/MasterEditorMenu.hx",167,0x3933e087)
namespace editors{
...
HXLINE(  47)		bg1->scrollFactor->set(null(),null());
...
HXLINE(  83)		::flixel::FlxG_obj::mouse->set_visible(false);
HXLINE(  84)		this->super::create();
            	}


void MasterEditorMenu_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_aa1a162bced268b8_88_update)
HXLINE(  89)		if (::PlayerSettings_obj::player1->controls->_ui_upP->check()) {
HXLINE(  91)			this->changeSelection(-1);
            		}
HXLINE(  93)		if (::PlayerSettings_obj::player1->controls->_ui_downP->check()) {
HXLINE(  95)			this->changeSelection(1);
            		}
HXLINE(  98)		if (::PlayerSettings_obj::player1->controls->_ui_leftP->check()) {
HXLINE( 100)			this->changeDirectory(-1);
            		}
HXLINE( 102)		if (::PlayerSettings_obj::player1->controls->_ui_rightP->check()) {
...
HXDLIN( 119)				goto _hx_goto_5;
            			...
            			_hx_goto_5:;
HXLINE( 129)			::flixel::FlxG_obj::sound->music->set_volume(( (Float)(0) ));
HXLINE( 131)			::FreeplayState_obj::destroyFreeplayVocals();
            		}
HXLINE( 135)		int bullShit = 0;
HXLINE( 136)		{
HXLINE( 136)			int _g = 0;
HXDLIN( 136)			::Array< ::Dynamic> _g1 = this->grpTexts->members;
HXDLIN( 136)			while((_g < _g1->length)){
HXLINE( 136)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 136)				_g = (_g + 1);
HXLINE( 138)				item->targetY = ( (Float)((bullShit - this->curSelected)) );
HXLINE( 139)				bullShit = (bullShit + 1);
HXLINE( 141)				item->set_alpha(((Float)0.6));
HXLINE( 144)				if ((item->targetY == 0)) {
HXLINE( 146)					item->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
...
void MasterEditorMenu_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_aa1a162bced268b8_154_changeSelection)
HXLINE( 155)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 155)		_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 157)		 ::editors::MasterEditorMenu _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 157)		_hx_tmp1->curSelected = (_hx_tmp1->curSelected + change);
HXLINE( 159)		if ((this->curSelected < 0)) {
HXLINE( 160)			this->curSelected = (this->options->length - 1);
            		}
HXLINE( 161)		if ((this->curSelected >= this->options->length)) {
HXLINE( 162)			this->curSelected = 0;
            		}
            	}
...
void MasterEditorMenu_obj::changeDirectory(::hx::Null< int >  __o_change){
            		int change = __o_change.Default(0);
            	HX_STACKFRAME(&_hx_pos_aa1a162bced268b8_167_changeDirectory)
...
HXLINE( 170)		 ::editors::MasterEditorMenu _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 170)		_hx_tmp1->curDirectory = (_hx_tmp1->curDirectory + change);
HXLINE( 172)		if ((this->curDirectory < 0)) {
HXLINE( 173)			this->curDirectory = (this->directories->length - 1);
            		}
HXLINE( 174)		if ((this->curDirectory >= this->directories->length)) {
HXLINE( 175)			this->curDirectory = 0;
            		}
HXLINE( 177)		::WeekData_obj::setDirectoryFromWeek(null());
HXLINE( 178)		bool _hx_tmp2;
HXDLIN( 178)		if (::hx::IsNotNull( this->directories->__get(this->curDirectory) )) {
HXLINE( 178)			_hx_tmp2 = (this->directories->__get(this->curDirectory).length < 1);
            		}
            		else {
HXLINE( 178)			_hx_tmp2 = true;
            		}
HXDLIN( 178)		if (_hx_tmp2) {
HXLINE( 179)			this->directoryTxt->set_text(HX_("< No Mod Directory Loaded >",6f,05,c4,e1));
            		}
            		else {
HXLINE( 182)			::Paths_obj::currentModDirectory = this->directories->__get(this->curDirectory);
HXLINE( 183)			this->directoryTxt->set_text(((HX_("< Loaded Mod Directory: ",1e,b9,7b,3e) + ::Paths_obj::currentModDirectory) + HX_(" >",1e,1c,00,00)));
            		}
HXLINE( 185)		 ::flixel::text::FlxText _hx_tmp3 = this->directoryTxt;
HXDLIN( 185)		_hx_tmp3->set_text(this->directoryTxt->text.toUpperCase());
            	}
