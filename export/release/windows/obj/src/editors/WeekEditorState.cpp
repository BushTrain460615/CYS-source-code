...
HXDLIN(  62)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("campaign_menu_UI_assets",fd,f3,ba,6a),library);
HXDLIN(  62)		 ::flixel::graphics::FlxGraphic graphic = returnAsset;
...
HXDLIN(  62)		::String ui_tex;
HXDLIN(  62)		if (xmlExists) {
HXLINE(  62)			ui_tex = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("campaign_menu_UI_assets",fd,f3,ba,6a)) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE(  62)			ui_tex = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("campaign_menu_UI_assets",fd,f3,ba,6a)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            		}
HXDLIN(  62)		 ::flixel::graphics::frames::FlxAtlasFrames ui_tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(graphic,ui_tex);
...
HXLINE(  78)		this->lock->set_frames(ui_tex1);
...
HXDLIN( 102)		 ::flixel::graphics::FlxGraphic returnAsset1 = ::Paths_obj::returnGraphic(HX_("Menu_Tracks",68,85,99,50),library1);
HXDLIN( 102)		 ::flixel::FlxSprite tracksSprite1 = tracksSprite->loadGraphic(returnAsset1,null(),null(),null(),null(),null());
...
HXLINE( 304)				{
HXLINE( 304)					 ::flixel::text::FlxText _g = this->txtTracklist;
HXDLIN( 304)					_g->set_text((_g->text + (stringThing->__get(i) + HX_("\n",0a,00,00,00))));
            				}
            			}
            		}
...
HXLINE( 310)		{
HXLINE( 310)			 ::flixel::text::FlxText _g6 = this->txtTracklist;
HXDLIN( 310)			_g6->set_x((_g6->x - (( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.35))));
            		}
...
HXLINE( 322)				_hx_tmp = ::openfl::utils::Assets_obj::exists(::Paths_obj::getPath((HX_("images/menubackgrounds/menu_",80,93,47,d3) + assetName),HX_("IMAGE",3b,57,57,3b),null()),HX_("IMAGE",3b,57,57,3b));
            			}
            			else {
...
HXDLIN( 324)				 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic((HX_("menubackgrounds/menu_",57,51,99,49) + assetName),library);
HXDLIN( 324)				_hx_tmp->loadGraphic(returnAsset,null(),null(),null(),null(),null());
...
HXLINE( 341)				_hx_tmp = ::openfl::utils::Assets_obj::exists(::Paths_obj::getPath((HX_("images/storymenu/",d2,44,94,b2) + assetName),HX_("IMAGE",3b,57,57,3b),null()),HX_("IMAGE",3b,57,57,3b));
            			}
            			else {
...
HXDLIN( 343)				 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic((HX_("storymenu/",9b,19,38,af) + assetName),library);
HXDLIN( 343)				_hx_tmp->loadGraphic(returnAsset,null(),null(),null(),null(),null());
...
HXLINE( 363)			if (::hx::IsEq( sender,this->weekFileInputText )) {
...
HXDLIN( 366)				if (::hx::IsNotEq( sender,this->opponentInputText )) {
HXLINE( 366)					_hx_tmp1 = ::hx::IsEq( sender,this->boyfriendInputText );
            				}
            				else {
HXLINE( 366)					_hx_tmp1 = true;
            				}
HXDLIN( 366)				if (!(_hx_tmp1)) {
HXLINE( 366)					_hx_tmp = ::hx::IsEq( sender,this->girlfriendInputText );
            				}
            				else {
...
HXLINE( 371)					if (::hx::IsEq( sender,this->backgroundInputText )) {
...
HXLINE( 374)						if (::hx::IsEq( sender,this->displayNameInputText )) {
...
HXLINE( 377)							if (::hx::IsEq( sender,this->weekNameInputText )) {
...
HXLINE( 379)								if (::hx::IsEq( sender,this->songsInputText )) {
...
HXLINE( 401)									if (::hx::IsEq( sender,this->weekBeforeInputText )) {
...
HXLINE( 403)										if (::hx::IsEq( sender,this->difficultiesInputText )) {
...
HXDLIN( 437)				 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),HX_("freakyMenu",15,c9,93,86),library);
HXDLIN( 437)				_hx_tmp->playMusic(file,null(),null(),null());
            			}
            		}
