...
HXDLIN( 228)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(key,library);
HXDLIN( 228)		 ::flixel::graphics::FlxGraphic graphic = returnAsset;
...
HXDLIN( 228)		::String _hx_tmp;
HXDLIN( 228)		if (xmlExists) {
HXLINE( 228)			_hx_tmp = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE( 228)			_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            		}
HXDLIN( 228)		_hx_char->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(graphic,_hx_tmp));
...
HXLINE( 256)				if (::hx::IsEq( sender,this->scaleStepper )) {
...
HXDLIN( 283)				 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),HX_("freakyMenu",15,c9,93,86),library);
HXDLIN( 283)				_hx_tmp->playMusic(file,null(),null(),null());
            			}
...
HXLINE( 290)				::Array< int > _hx_tmp = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 290)				int _hx_tmp1 = 0;
HXDLIN( 290)				_hx_tmp[_hx_tmp1] = (_hx_tmp->__get(_hx_tmp1) + shiftMult);
...
HXLINE( 294)				::Array< int > _hx_tmp = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 294)				int _hx_tmp1 = 0;
HXDLIN( 294)				_hx_tmp[_hx_tmp1] = (_hx_tmp->__get(_hx_tmp1) - shiftMult);
...
HXLINE( 298)				::Array< int > _hx_tmp = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 298)				int _hx_tmp1 = 1;
HXDLIN( 298)				_hx_tmp[_hx_tmp1] = (_hx_tmp->__get(_hx_tmp1) + shiftMult);
...
HXLINE( 302)				::Array< int > _hx_tmp = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 302)				int _hx_tmp1 = 1;
HXDLIN( 302)				_hx_tmp[_hx_tmp1] = (_hx_tmp->__get(_hx_tmp1) - shiftMult);
