...
HXDLIN(  34)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("menuBGBlue",de,35,e3,1e),library);
HXDLIN(  34)		 ::flixel::FlxSprite menuBG1 = menuBG->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE(  35)		Float _hx_tmp = (menuBG1->get_width() * ((Float)1.1));
HXDLIN(  35)		menuBG1->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * this->scaleRatio)),null());
HXLINE(  36)		menuBG1->updateHitbox();
HXLINE(  37)		menuBG1->screenCenter(null());
HXLINE(  38)		menuBG1->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE(  39)		this->add(menuBG1);
...
HXDLIN(  45)				if (( (bool)(::Achievements_obj::achievementsStuff->__get(i)->__GetItem(4)) )) {
...
HXDLIN(  53)				if (( (bool)(::Achievements_obj::isAchievementUnlocked(achieveName)) )) {
...
HXLINE(  55)				{
HXLINE(  55)					 ::Alphabet _g = optionText1;
HXDLIN(  55)					_g->set_x((_g->x + 280));
            				}
...
HXLINE(  67)		 ::flixel::text::FlxText _hx_tmp1 = this->descText;
HXDLIN(  67)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(  67)		::String _hx_tmp2;
HXDLIN(  67)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(  67)			_hx_tmp2 = file;
            		}
            		else {
HXLINE(  67)			_hx_tmp2 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(  67)		_hx_tmp1->setFormat(_hx_tmp2,32,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
