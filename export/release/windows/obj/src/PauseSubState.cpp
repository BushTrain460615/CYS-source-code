...
HXDLIN(  50)		 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),HX_("breakfast",db,b2,0c,49),library);
HXDLIN(  50)		this->pauseMusic = _hx_tmp->loadEmbedded(file,true,true,null());
HXLINE(  51)		this->pauseMusic->set_volume(( (Float)(0) ));
HXLINE(  52)		 ::flixel::_hx_system::FlxSound _hx_tmp1 = this->pauseMusic;
HXDLIN(  52)		 ::flixel::math::FlxRandom _hx_tmp2 = ::flixel::FlxG_obj::random;
HXDLIN(  52)		_hx_tmp1->play(false,_hx_tmp2->_hx_int(0,::Std_obj::_hx_int((this->pauseMusic->_length / ( (Float)(2) ))),null()),null());
...
HXLINE(  62)		{
HXLINE(  62)			 ::flixel::text::FlxText _g2 = levelInfo;
HXDLIN(  62)			_g2->set_text(( (::String)((_g2->text + ::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic))) ));
            		}
...
HXLINE(  64)			_hx_tmp3 = file1;
            		}
            		else {
HXLINE(  64)			_hx_tmp3 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(  64)		levelInfo->setFormat(_hx_tmp3,32,null(),null(),null(),null(),null());
...
HXLINE(  69)		{
HXLINE(  69)			 ::flixel::text::FlxText _g3 = levelDifficulty;
HXDLIN(  69)			::String _g4 = _g3->text;
HXDLIN(  69)			_g3->set_text((_g4 + ::CoolUtil_obj::difficultyString()));
            		}
...
HXLINE(  71)			_hx_tmp4 = file2;
            		}
            		else {
HXLINE(  71)			_hx_tmp4 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(  71)		levelDifficulty->setFormat(_hx_tmp4,32,null(),null(),null(),null(),null());
...
HXDLIN(  78)		::String _hx_tmp5;
HXDLIN(  78)		if (::sys::FileSystem_obj::exists(file3)) {
HXLINE(  78)			_hx_tmp5 = file3;
            		}
            		else {
HXLINE(  78)			_hx_tmp5 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(  78)		blueballedTxt->setFormat(_hx_tmp5,32,null(),null(),null(),null(),null());
...
HXLINE(  84)		 ::flixel::text::FlxText _hx_tmp6 = this->practiceText;
HXDLIN(  84)		::String file4 = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(  84)		::String _hx_tmp7;
HXDLIN(  84)		if (::sys::FileSystem_obj::exists(file4)) {
HXLINE(  84)			_hx_tmp7 = file4;
            		}
            		else {
HXLINE(  84)			_hx_tmp7 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(  84)		_hx_tmp6->setFormat(_hx_tmp7,32,null(),null(),null(),null(),null());
HXLINE(  85)		 ::flixel::text::FlxText _hx_tmp8 = this->practiceText;
HXDLIN(  85)		int _hx_tmp9 = ::flixel::FlxG_obj::width;
HXDLIN(  85)		_hx_tmp8->set_x((( (Float)(_hx_tmp9) ) - (this->practiceText->get_width() + 20)));
...
HXDLIN(  92)		::String _hx_tmp10;
HXDLIN(  92)		if (::sys::FileSystem_obj::exists(file5)) {
HXLINE(  92)			_hx_tmp10 = file5;
            		}
            		else {
HXLINE(  92)			_hx_tmp10 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(  92)		chartingText->setFormat(_hx_tmp10,32,null(),null(),null(),null(),null());
HXLINE(  93)		int _hx_tmp11 = ::flixel::FlxG_obj::width;
HXDLIN(  93)		chartingText->set_x((( (Float)(_hx_tmp11) ) - (chartingText->get_width() + 20)));
HXLINE(  94)		int _hx_tmp12 = ::flixel::FlxG_obj::height;
HXDLIN(  94)		chartingText->set_y((( (Float)(_hx_tmp12) ) - (chartingText->get_height() + 20)));
...
HXLINE( 103)		int _hx_tmp13 = ::flixel::FlxG_obj::width;
HXDLIN( 103)		levelInfo->set_x((( (Float)(_hx_tmp13) ) - (levelInfo->get_width() + 20)));
HXLINE( 104)		int _hx_tmp14 = ::flixel::FlxG_obj::width;
HXDLIN( 104)		levelDifficulty->set_x((( (Float)(_hx_tmp14) ) - (levelDifficulty->get_width() + 20)));
HXLINE( 105)		int _hx_tmp15 = ::flixel::FlxG_obj::width;
HXDLIN( 105)		blueballedTxt->set_x((( (Float)(_hx_tmp15) ) - (blueballedTxt->get_width() + 20)));
...
HXDLIN( 115)			int _g6 = this->menuItems->length;
HXDLIN( 115)			while((_g5 < _g6)){
HXLINE( 115)				_g5 = (_g5 + 1);
HXDLIN( 115)				int i = (_g5 - 1);
...
HXLINE( 131)			 ::flixel::_hx_system::FlxSound _g = this->pauseMusic;
HXDLIN( 131)			_g->set_volume((_g->_volume + (((Float)0.01) * elapsed)));
            		}
...
HXDLIN( 191)				 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),HX_("freakyMenu",15,c9,93,86),library);
HXDLIN( 191)				_hx_tmp->playMusic(file,null(),null(),null());
