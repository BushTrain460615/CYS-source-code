...
HXDLIN(  16)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("checkboxanim",d4,35,91,c5),library);
HXDLIN(  16)		 ::flixel::graphics::FlxGraphic graphic = returnAsset;
...
HXLINE(  16)			_hx_tmp = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("checkboxanim",d4,35,91,c5)) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE(  16)			_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("checkboxanim",d4,35,91,c5)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            		}
HXDLIN(  16)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(graphic,_hx_tmp));
...
HXLINE(  26)			_hx_tmp1 = HX_("checking",1a,21,fb,ac);
            		}
            		else {
HXLINE(  26)			_hx_tmp1 = HX_("unchecking",73,08,bf,32);
            		}
HXDLIN(  26)		this->animationFinished(_hx_tmp1);
