...
HXDLIN(  12)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("limo/limoDancer",8e,b6,e5,ea),library);
HXDLIN(  12)		 ::flixel::graphics::FlxGraphic graphic = returnAsset;
HXDLIN(  12)		bool xmlExists = false;
HXDLIN(  12)		if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("limo/limoDancer",8e,b6,e5,ea)) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE(  12)			xmlExists = true;
            		}
HXDLIN(  12)		::String _hx_tmp;
HXDLIN(  12)		if (xmlExists) {
HXLINE(  12)			_hx_tmp = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("limo/limoDancer",8e,b6,e5,ea)) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE(  12)			_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("limo/limoDancer",8e,b6,e5,ea)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            		}
HXDLIN(  12)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(graphic,_hx_tmp));
