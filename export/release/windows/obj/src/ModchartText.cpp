...
HX_DEFINE_STACK_FRAME(_hx_pos_552a6f94cb341f6a_1986_new,"ModchartText","new",0x58e3633b,"ModchartText.new","FunkinLua.hx",1986,0x00117937)

void ModchartText_obj::__construct(Float x,Float y,::String text,Float width){
            	HX_STACKFRAME(&_hx_pos_552a6f94cb341f6a_1986_new)
HXLINE(1988)		this->wasAdded = false;
HXLINE(1991)		super::__construct(x,y,width,text,16,null());
HXLINE(1992)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(1992)		::String _hx_tmp;
HXDLIN(1992)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(1992)			_hx_tmp = file;
            		}
            		else {
HXLINE(1992)			_hx_tmp = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(1992)		this->setFormat(_hx_tmp,16,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(1993)		this->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::PlayState_obj::instance->camHUD));
HXLINE(1994)		this->scrollFactor->set(null(),null());
HXLINE(1995)		this->set_borderSize(( (Float)(2) ));
            	}
