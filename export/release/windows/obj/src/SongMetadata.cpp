...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_483_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",483,0x0d86f62d)

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_483_new)
HXLINE( 489)		this->folder = HX_("",00,00,00,00);
HXLINE( 488)		this->color = -7179779;
HXLINE( 487)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 486)		this->week = 0;
HXLINE( 485)		this->songName = HX_("",00,00,00,00);
HXLINE( 493)		this->songName = song;
HXLINE( 494)		this->week = week;
HXLINE( 495)		this->songCharacter = songCharacter;
HXLINE( 496)		this->color = color;
HXLINE( 497)		this->folder = ::Paths_obj::currentModDirectory;
HXLINE( 498)		if (::hx::IsNull( this->folder )) {
HXLINE( 498)			this->folder = HX_("",00,00,00,00);
            		}
            	}
