...
HXDLIN(  23)			 ::flixel::graphics::FlxGraphic graphic = returnAsset;
...
HXLINE(  23)				_hx_tmp = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + file) + HX_(".xml",69,3e,c3,1e))));
            			}
            			else {
HXLINE(  23)				_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + file) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            			}
HXDLIN(  23)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(graphic,_hx_tmp));
