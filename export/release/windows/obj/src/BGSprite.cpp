...
HXDLIN(  13)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(image,library);
HXDLIN(  13)			 ::flixel::graphics::FlxGraphic graphic = returnAsset;
...
HXLINE(  13)				_hx_tmp = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + image) + HX_(".xml",69,3e,c3,1e))));
            			}
            			else {
HXLINE(  13)				_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + image) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            			}
HXDLIN(  13)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(graphic,_hx_tmp));
HXLINE(  14)			{
HXLINE(  14)				int _g = 0;
