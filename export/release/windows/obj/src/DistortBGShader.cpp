...
HX_DEFINE_STACK_FRAME(_hx_pos_25ce555c6eebef3c_1271_new,"DistortBGShader","new",0xa788f367,"DistortBGShader.new","Shaders.hx",1271,0x469785f0)

void DistortBGShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_25ce555c6eebef3c_1271_new)
...
HXLINE(1272)		super::__construct();
HXLINE(1222)		this->_hx___isGenerated = true;
HXDLIN(1222)		this->_hx___initGL();
            	}
