...
HX_LOCAL_STACK_FRAME(_hx_pos_128129519e640548_230_spawnCharacters,"DialogueBoxPsych","spawnCharacters",0xbe2056df,"DialogueBoxPsych.spawnCharacters","DialogueBoxPsych.hx",230,0xf6ef1736)
...
HX_LOCAL_STACK_FRAME(_hx_pos_128129519e640548_228_boot,"DialogueBoxPsych","boot",0xde4e15d8,"DialogueBoxPsych.boot","DialogueBoxPsych.hx",228,0xf6ef1736)
...
HXLINE( 224)		this->dialogueEnded = false;
HXLINE( 223)		this->dialogueStarted = false;
HXLINE( 181)		this->curCharacter = HX_("",00,00,00,00);
...
HXLINE( 186)		super::__construct(null(),null(),null());
HXLINE( 188)		bool _hx_tmp;
HXDLIN( 188)		if (::hx::IsNotNull( song )) {
HXLINE( 188)			_hx_tmp = (song != HX_("",00,00,00,00));
            		}
            		else {
...
HXDLIN( 189)			 ::openfl::media::Sound file = ::Paths_obj::returnSound(HX_("music",a5,d0,5a,10),song,library);
HXDLIN( 189)			_hx_tmp->playMusic(file,0,null(),null());
HXLINE( 190)			{
HXLINE( 190)				 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
...
HXDLIN( 190)				_this->fadeTween = ::flixel::tweens::FlxTween_obj::num(( (Float)(0) ),( (Float)(1) ),2, ::Dynamic(::hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("onComplete",f8,d4,7e,5d),onComplete)),_this->volumeTween_dyn());
            			}
            		}
HXLINE( 193)		 ::flixel::FlxSprite _hx_tmp1 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-500,-500,null());
HXDLIN( 193)		this->bgFade = _hx_tmp1->makeGraphic((::flixel::FlxG_obj::width * 2),(::flixel::FlxG_obj::height * 2),-1,null(),null());
HXLINE( 194)		this->bgFade->scrollFactor->set(null(),null());
HXLINE( 195)		this->bgFade->set_visible(true);
HXLINE( 196)		this->bgFade->set_alpha(( (Float)(0) ));
HXLINE( 197)		this->add(this->bgFade);
HXLINE( 199)		this->dialogueList = dialogueList;
HXLINE( 200)		this->spawnCharacters();
HXLINE( 202)		this->box =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,70,370,null());
HXLINE( 203)		 ::flixel::FlxSprite _hx_tmp2 = this->box;
HXDLIN( 203)		::String library = null();
HXDLIN( 203)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("speech_bubble",49,db,97,da),library);
HXDLIN( 203)		 ::flixel::graphics::FlxGraphic graphic = returnAsset;
HXDLIN( 203)		bool xmlExists = false;
HXDLIN( 203)		if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("speech_bubble",49,db,97,da)) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 203)			xmlExists = true;
            		}
HXDLIN( 203)		::String _hx_tmp3;
HXDLIN( 203)		if (xmlExists) {
HXLINE( 203)			_hx_tmp3 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("speech_bubble",49,db,97,da)) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE( 203)			_hx_tmp3 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("speech_bubble",49,db,97,da)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            		}
HXDLIN( 203)		_hx_tmp2->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(graphic,_hx_tmp3));
HXLINE( 204)		this->box->scrollFactor->set(null(),null());
HXLINE( 205)		this->box->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 206)		this->box->animation->addByPrefix(HX_("normal",27,72,69,30),HX_("speech bubble normal",bd,d5,bc,a7),24,null(),null(),null());
HXLINE( 207)		this->box->animation->addByPrefix(HX_("normalOpen",91,41,38,70),HX_("Speech Bubble Normal Open",0d,59,3f,7c),24,false,null(),null());
HXLINE( 208)		this->box->animation->addByPrefix(HX_("angry",21,49,e2,22),HX_("AHH speech bubble",eb,de,b2,20),24,null(),null(),null());
HXLINE( 209)		this->box->animation->addByPrefix(HX_("angryOpen",8b,1d,01,b1),HX_("speech bubble loud open",42,35,10,f0),24,false,null(),null());
HXLINE( 210)		this->box->animation->addByPrefix(HX_("center-normal",df,c0,ab,9c),HX_("speech bubble middle",eb,36,b2,c3),24,null(),null(),null());
HXLINE( 211)		this->box->animation->addByPrefix(HX_("center-normalOpen",49,4c,74,58),HX_("Speech Bubble Middle Open",1f,f1,94,ea),24,false,null(),null());
HXLINE( 212)		this->box->animation->addByPrefix(HX_("center-angry",69,39,92,b0),HX_("AHH Speech Bubble middle",ea,0b,3d,74),24,null(),null(),null());
HXLINE( 213)		this->box->animation->addByPrefix(HX_("center-angryOpen",d3,d1,42,e2),HX_("speech bubble Middle loud open",c3,b9,85,ee),24,false,null(),null());
HXLINE( 214)		this->box->animation->play(HX_("normal",27,72,69,30),true,null(),null());
HXLINE( 215)		this->box->set_visible(false);
HXLINE( 216)		 ::flixel::FlxSprite _hx_tmp4 = this->box;
HXDLIN( 216)		_hx_tmp4->setGraphicSize(::Std_obj::_hx_int((this->box->get_width() * ((Float)0.9))),null());
HXLINE( 217)		this->box->updateHitbox();
HXLINE( 218)		this->add(this->box);
HXLINE( 220)		this->startNextDialog();
            	}
...
void DialogueBoxPsych_obj::spawnCharacters(){
            	HX_GC_STACKFRAME(&_hx_pos_128129519e640548_230_spawnCharacters)
HXLINE( 232)		 ::haxe::ds::StringMap charsMap =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 236)		{
HXLINE( 236)			int _g = 0;
HXDLIN( 236)			int _g1 = ( (::Array< ::Dynamic>)(this->dialogueList->__Field(HX_("dialogue",18,2d,94,a7),::hx::paccDynamic)) )->length;
HXDLIN( 236)			while((_g < _g1)){
HXLINE( 236)				_g = (_g + 1);
HXDLIN( 236)				int i = (_g - 1);
HXLINE( 237)				if (::hx::IsNotNull(  ::Dynamic(this->dialogueList->__Field(HX_("dialogue",18,2d,94,a7),::hx::paccDynamic))->__GetItem(i) )) {
HXLINE( 238)					::String charToAdd = ( (::String)( ::Dynamic(this->dialogueList->__Field(HX_("dialogue",18,2d,94,a7),::hx::paccDynamic))->__GetItem(i)->__Field(HX_("portrait",5b,21,af,b8),::hx::paccDynamic)) );
HXLINE( 239)					bool _hx_tmp;
HXDLIN( 239)					if (charsMap->exists(charToAdd)) {
HXLINE( 239)						_hx_tmp = !(( (bool)(charsMap->get(charToAdd)) ));
            					}
            					else {
HXLINE( 239)						_hx_tmp = true;
            					}
HXDLIN( 239)					if (_hx_tmp) {
HXLINE( 240)						charsMap->set(charToAdd,true);
            					}
            				}
            			}
            		}
HXLINE( 245)		{
HXLINE( 245)			 ::Dynamic individualChar = charsMap->keys();
HXDLIN( 245)			while(( (bool)(individualChar->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 245)				::String individualChar1 = ( (::String)(individualChar->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 246)				Float x = ::DialogueBoxPsych_obj::LEFT_CHAR_X;
HXLINE( 247)				Float y = ::DialogueBoxPsych_obj::DEFAULT_CHAR_Y;
HXLINE( 248)				 ::DialogueCharacter _hx_char =  ::DialogueCharacter_obj::__alloc( HX_CTX ,(x + this->offsetPos),y,individualChar1);
...
HXLINE( 260)					{
HXLINE( 260)						 ::DialogueCharacter _g = _hx_char;
HXDLIN( 260)						Float _g1 = _g->x;
HXDLIN( 260)						_g->set_x((_g1 - (_hx_char->get_width() / ( (Float)(2) ))));
            					}
...
HXLINE( 270)				{
HXLINE( 270)					 ::DialogueCharacter _g = _hx_char;
HXDLIN( 270)					_g->set_x((_g->x +  ::Dynamic(_hx_char->jsonFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic))->__GetItem(0)));
            				}
HXLINE( 271)				{
HXLINE( 271)					 ::DialogueCharacter _g1 = _hx_char;
HXDLIN( 271)					_g1->set_y((_g1->y +  ::Dynamic(_hx_char->jsonFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic))->__GetItem(1)));
            				}
...
HXLINE( 291)			{
HXLINE( 291)				 ::flixel::FlxSprite _g = this->bgFade;
HXDLIN( 291)				_g->set_alpha((_g->alpha + (((Float)0.5) * elapsed)));
            			}
...
HXLINE( 362)							::String _hx_switch_0 = ( (::String)(_hx_char->jsonFile->__Field(HX_("dialogue_pos",ad,3b,6d,1a),::hx::paccDynamic)) );
            							if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE( 367)								{
HXLINE( 367)									 ::DialogueCharacter _g = _hx_char;
HXDLIN( 367)									_g->set_y((_g->y + (( (Float)(this->scrollSpeed) ) * elapsed)));
            								}
...
HXLINE( 364)								{
HXLINE( 364)									 ::DialogueCharacter _g = _hx_char;
HXDLIN( 364)									_g->set_x((_g->x - (( (Float)(this->scrollSpeed) ) * elapsed)));
            								}
...
HXDLIN( 373)								_g->set_alpha((_g->alpha - (( (Float)(3) ) * elapsed)));
            							}
...
HXLINE( 381)								{
HXLINE( 381)									 ::DialogueCharacter _g = _hx_char;
HXDLIN( 381)									_g->set_y((_g->y - (( (Float)(this->scrollSpeed) ) * elapsed)));
            								}
...
HXLINE( 378)								{
HXLINE( 378)									 ::DialogueCharacter _g = _hx_char;
HXDLIN( 378)									_g->set_x((_g->x + (( (Float)(this->scrollSpeed) ) * elapsed)));
            								}
...
HXDLIN( 387)								_g->set_alpha((_g->alpha + (( (Float)(3) ) * elapsed)));
            							}
...
HXLINE( 402)				{
HXLINE( 402)					 ::flixel::FlxSprite _g = this->bgFade;
HXDLIN( 402)					_g->set_alpha((_g->alpha - (((Float)0.5) * elapsed)));
            				}
...
HXDLIN( 418)							_g->set_y((_g->y + (( (Float)(this->scrollSpeed) ) * elapsed)));
...
HXLINE( 420)							 ::DialogueCharacter _g = leChar;
HXDLIN( 420)							_g->set_x((_g->x + (( (Float)(this->scrollSpeed) ) * elapsed)));
HXDLIN( 420)							goto _hx_goto_14;
            						}
            						_hx_goto_14:;
HXLINE( 422)						{
HXLINE( 422)							 ::DialogueCharacter _g = leChar;
HXDLIN( 422)							_g->set_alpha((_g->alpha - (elapsed * ( (Float)(10) ))));
            						}
            					}
            				}
            			}
...
HXLINE( 536)			 ::flixel::math::FlxPoint _g = box->offset;
HXDLIN( 536)			_g->set_y((_g->y + 10));
            		}
            	}
...
HXDLIN( 226)		LEFT_CHAR_X = ((Float)-60);
            	}
{
            	HX_STACKFRAME(&_hx_pos_128129519e640548_227_boot)
HXDLIN( 227)		RIGHT_CHAR_X = ((Float)-100);
            	}
{
            	HX_STACKFRAME(&_hx_pos_128129519e640548_228_boot)
HXDLIN( 228)		DEFAULT_CHAR_Y = ((Float)60);
            	}
{
