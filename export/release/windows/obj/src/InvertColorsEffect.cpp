...
HX_DEFINE_STACK_FRAME(_hx_pos_cd330a62fd89da64_1140_new,"InvertColorsEffect","new",0x5fd46129,"InvertColorsEffect.new","Shaders.hx",1140,0x469785f0)

void InvertColorsEffect_obj::__construct(bool lockAlpha){
            	HX_GC_STACKFRAME(&_hx_pos_cd330a62fd89da64_1140_new)
HXDLIN(1140)		this->shader =  ::InvertShader_obj::__alloc( HX_CTX );
            	}
