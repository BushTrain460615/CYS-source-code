...
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_128_browserLoad,"CoolUtil","browserLoad",0xdac4a08b,"CoolUtil.browserLoad","CoolUtil.hx",128,0x9f143813)
...
HXLINE( 119)		::String EmbeddedSound = ( (::String)(::Paths_obj::sound(sound,library)) );
HXLINE( 120)		bool _hx_tmp;
HXDLIN( 120)		if (!(::openfl::utils::Assets_obj::exists(EmbeddedSound,HX_("SOUND",af,c4,ba,fe)))) {
HXLINE( 120)			_hx_tmp = ::openfl::utils::Assets_obj::exists(EmbeddedSound,HX_("MUSIC",85,08,49,8e));
            		}
            		else {
HXLINE( 120)			_hx_tmp = true;
            		}
HXDLIN( 120)		if (_hx_tmp) {
HXLINE( 121)			::openfl::utils::Assets_obj::getSound(EmbeddedSound,true);
            		}
            	}
...
void CoolUtil_obj::browserLoad(::String site){
            	HX_GC_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_128_browserLoad)
HXDLIN( 128)		::String prefix = HX_("",00,00,00,00);
HXDLIN( 128)		if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(site))) {
HXDLIN( 128)			prefix = HX_("http://",52,75,cd,5a);
            		}
HXDLIN( 128)		::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + site)),HX_("_blank",95,26,d9,b0));
            	}
...
HXDLIN(  19)		defaultDifficulties = ::Array_obj< ::String >::fromData( _hx_array_data_c96d938b_16,3);
            	}
{
