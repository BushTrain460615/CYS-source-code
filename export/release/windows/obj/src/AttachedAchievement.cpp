...
HX_DEFINE_STACK_FRAME(_hx_pos_ec6539926560d3c0_221_new,"AttachedAchievement","new",0x78b415bd,"AttachedAchievement.new","Achievements.hx",221,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_ec6539926560d3c0_228_changeAchievement,"AttachedAchievement","changeAchievement",0x3f6c6afc,"AttachedAchievement.changeAchievement","Achievements.hx",228,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_ec6539926560d3c0_233_reloadAchievementImage,"AttachedAchievement","reloadAchievementImage",0x2581b6a8,"AttachedAchievement.reloadAchievementImage","Achievements.hx",233,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_ec6539926560d3c0_258_update,"AttachedAchievement","update",0x63d738cc,"AttachedAchievement.update","Achievements.hx",258,0xf249f7fa)

void AttachedAchievement_obj::__construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::String name){
            		Float x = __o_x.Default(0);
            		Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_221_new)
HXLINE( 222)		super::__construct(x,y,null());
HXLINE( 224)		this->changeAchievement(name);
HXLINE( 225)		this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
            	}
...
void AttachedAchievement_obj::changeAchievement(::String tag){
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_228_changeAchievement)
HXLINE( 229)		this->tag = tag;
HXLINE( 230)		this->reloadAchievementImage();
            	}
...
void AttachedAchievement_obj::reloadAchievementImage(){
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_233_reloadAchievementImage)
HXLINE( 234)		if (( (bool)(::Achievements_obj::isAchievementUnlocked(this->tag)) )) {
HXLINE( 235)			::String library = null();
HXDLIN( 235)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("achievementgrid",b5,fa,02,8a),library);
HXDLIN( 235)			 ::flixel::graphics::FlxGraphic imagePath = returnAsset;
HXLINE( 236)			bool isModIcon = false;
HXLINE( 238)			if (::Achievements_obj::loadedAchievements->exists(this->tag)) {
HXLINE( 239)				isModIcon = true;
HXLINE( 240)				::String library = null();
HXDLIN( 240)				 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(( (::String)(::Achievements_obj::loadedAchievements->get(this->tag)->__Field(HX_("icon",79,e7,b2,45),::hx::paccDynamic)) ),library);
HXDLIN( 240)				imagePath = returnAsset;
            			}
HXLINE( 243)			int index = ::Achievements_obj::getAchievementIndex(this->tag);
HXLINE( 244)			if (isModIcon) {
HXLINE( 244)				index = 0;
            			}
HXLINE( 246)			::haxe::Log_obj::trace(imagePath,::hx::SourceInfo(HX_("source/Achievements.hx",86,db,47,8f),246,HX_("AttachedAchievement",4b,73,b5,97),HX_("reloadAchievementImage",e5,0d,f3,8e)));
HXLINE( 248)			this->loadGraphic(imagePath,true,150,150,null(),null());
HXLINE( 249)			this->animation->add(HX_("icon",79,e7,b2,45),::Array_obj< int >::__new(1)->init(0,index),0,false,false,null());
HXLINE( 250)			this->animation->play(HX_("icon",79,e7,b2,45),null(),null(),null());
            		}
            		else {
HXLINE( 252)			::String library = null();
HXDLIN( 252)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("lockedachievement",a5,23,f4,2a),library);
HXDLIN( 252)			this->loadGraphic(returnAsset,null(),null(),null(),null(),null());
            		}
HXLINE( 254)		this->scale->set(((Float)0.7),((Float)0.7));
HXLINE( 255)		this->updateHitbox();
            	}
...
void AttachedAchievement_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_258_update)
HXLINE( 259)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE( 260)			this->setPosition((this->sprTracker->x - ( (Float)(130) )),(this->sprTracker->y + 25));
            		}
