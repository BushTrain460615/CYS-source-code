...
HX_DEFINE_STACK_FRAME(_hx_pos_f8fd466029c4d025_688_new,"ModMetadata","new",0x98e8f1a3,"ModMetadata.new","ModsMenuState.hx",688,0xc380473d)

void ModMetadata_obj::__construct(::String folder){
            	HX_GC_STACKFRAME(&_hx_pos_f8fd466029c4d025_688_new)
HXLINE( 689)		this->folder = folder;
HXLINE( 690)		this->name = folder;
HXLINE( 691)		this->description = HX_("No description provided.",88,46,cb,66);
HXLINE( 692)		this->color = ::ModsMenuState_obj::defaultColor;
HXLINE( 693)		this->restart = false;
HXLINE( 696)		::String key = (folder + HX_("/pack.json",ce,a9,3a,e3));
HXDLIN( 696)		if (::hx::IsNull( key )) {
HXLINE( 696)			key = HX_("",00,00,00,00);
            		}
HXDLIN( 696)		::String path = (HX_("mods/",9e,2f,58,0c) + key);
HXLINE( 697)		if (::sys::FileSystem_obj::exists(path)) {
HXLINE( 698)			::String rawJson = ::sys::io::File_obj::getContent(path);
HXLINE( 699)			bool _hx_tmp;
HXDLIN( 699)			if (::hx::IsNotNull( rawJson )) {
HXLINE( 699)				_hx_tmp = (rawJson.length > 0);
            			}
            			else {
HXLINE( 699)				_hx_tmp = false;
            			}
HXDLIN( 699)			if (_hx_tmp) {
HXLINE( 700)				 ::Dynamic stuff =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
HXLINE( 702)				::Array< int > colors = ( (::Array< int >)(::Reflect_obj::getProperty(stuff,HX_("color",63,71,5c,4a))) );
HXLINE( 703)				::String description = ( (::String)(::Reflect_obj::getProperty(stuff,HX_("description",fc,08,1d,5f))) );
HXLINE( 704)				::String name = ( (::String)(::Reflect_obj::getProperty(stuff,HX_("name",4b,72,ff,48))) );
HXLINE( 705)				bool restart = ( (bool)(::Reflect_obj::getProperty(stuff,HX_("restart",cf,c7,a5,6a))) );
HXLINE( 707)				bool _hx_tmp;
HXDLIN( 707)				if (::hx::IsNotNull( name )) {
HXLINE( 707)					_hx_tmp = (name.length > 0);
            				}
            				else {
HXLINE( 707)					_hx_tmp = false;
            				}
HXDLIN( 707)				if (_hx_tmp) {
HXLINE( 709)					this->name = name;
            				}
HXLINE( 711)				bool _hx_tmp1;
HXDLIN( 711)				if (::hx::IsNotNull( description )) {
HXLINE( 711)					_hx_tmp1 = (description.length > 0);
            				}
            				else {
HXLINE( 711)					_hx_tmp1 = false;
            				}
HXDLIN( 711)				if (_hx_tmp1) {
HXLINE( 713)					this->description = description;
            				}
HXLINE( 715)				bool _hx_tmp2;
HXDLIN( 715)				if (::hx::IsNotNull( colors )) {
HXLINE( 715)					_hx_tmp2 = (colors->length > 2);
            				}
            				else {
HXLINE( 715)					_hx_tmp2 = false;
            				}
HXDLIN( 715)				if (_hx_tmp2) {
HXLINE( 717)					int Red = colors->__get(0);
HXDLIN( 717)					int Green = colors->__get(1);
HXDLIN( 717)					int Blue = colors->__get(2);
HXDLIN( 717)					int Alpha = 255;
HXDLIN( 717)					int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 717)					{
HXLINE( 717)						color = (color & -16711681);
HXDLIN( 717)						int color1;
HXDLIN( 717)						if ((Red > 255)) {
HXLINE( 717)							color1 = 255;
            						}
            						else {
HXLINE( 717)							if ((Red < 0)) {
HXLINE( 717)								color1 = 0;
...
HXLINE( 717)								color1 = Red;
            							}
            						}
HXDLIN( 717)						color = (color | (color1 << 16));
            					}
HXDLIN( 717)					{
HXLINE( 717)						color = (color & -65281);
HXDLIN( 717)						int color2;
HXDLIN( 717)						if ((Green > 255)) {
HXLINE( 717)							color2 = 255;
            						}
            						else {
HXLINE( 717)							if ((Green < 0)) {
HXLINE( 717)								color2 = 0;
            							}
            							else {
HXLINE( 717)								color2 = Green;
            							}
            						}
HXDLIN( 717)						color = (color | (color2 << 8));
            					}
HXDLIN( 717)					{
HXLINE( 717)						color = (color & -256);
HXDLIN( 717)						int color3;
HXDLIN( 717)						if ((Blue > 255)) {
HXLINE( 717)							color3 = 255;
            						}
            						else {
HXLINE( 717)							if ((Blue < 0)) {
HXLINE( 717)								color3 = 0;
            							}
            							else {
HXLINE( 717)								color3 = Blue;
            							}
            						}
HXDLIN( 717)						color = (color | color3);
            					}
HXDLIN( 717)					{
HXLINE( 717)						color = (color & 16777215);
HXDLIN( 717)						int color4;
HXDLIN( 717)						if ((Alpha > 255)) {
HXLINE( 717)							color4 = 255;
            						}
            						else {
HXLINE( 717)							if ((Alpha < 0)) {
HXLINE( 717)								color4 = 0;
            							}
            							else {
HXLINE( 717)								color4 = Alpha;
            							}
            						}
HXDLIN( 717)						color = (color | (color4 << 24));
            					}
HXDLIN( 717)					this->color = color;
            				}
HXLINE( 720)				this->restart = restart;
            			}
            		}
            	}
