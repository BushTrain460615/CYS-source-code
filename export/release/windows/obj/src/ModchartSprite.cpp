...
HX_DEFINE_STACK_FRAME(_hx_pos_2b7f7cc83b4d0792_1980_new,"ModchartSprite","new",0xbc67fd93,"ModchartSprite.new","FunkinLua.hx",1980,0x00117937)

void ModchartSprite_obj::__construct( ::Dynamic X, ::Dynamic Y, ::Dynamic SimpleGraphic){
            	HX_STACKFRAME(&_hx_pos_2b7f7cc83b4d0792_1980_new)
HXLINE(1982)		this->wasAdded = false;
HXLINE(1980)		super::__construct(X,Y,SimpleGraphic);
            	}
