...
HX_LOCAL_STACK_FRAME(_hx_pos_e389052d266a89dd_1336_setValue,"Effect","setValue",0x932919cc,"Effect.setValue","Shaders.hx",1336,0x469785f0)
...
void Effect_obj::setValue( ::flixel::graphics::tile::FlxGraphicsShader shader,::String variable,Float value){
            	HX_STACKFRAME(&_hx_pos_e389052d266a89dd_1336_setValue)
HXDLIN(1336)		::Reflect_obj::setProperty(::Reflect_obj::getProperty(shader,HX_("variable",3c,12,0d,69)),HX_("value",71,7f,b8,31),::cpp::VirtualArray_obj::__new(1)->init(0,value));
            	}
