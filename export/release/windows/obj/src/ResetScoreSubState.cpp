...
HXLINE(  49)		if ((week == -1)) {
HXLINE(  49)			 ::Alphabet _g = text1;
HXDLIN(  49)			_g->set_x((_g->x + (( (Float)(60) ) * tooLong)));
            		}
...
HXLINE(  64)		{
HXLINE(  64)			 ::Alphabet _g = this->yesText;
HXDLIN(  64)			_g->set_x((_g->x - ( (Float)(200) )));
            		}
...
HXLINE(  68)		{
HXLINE(  68)			 ::Alphabet _g1 = this->noText;
HXDLIN(  68)			_g1->set_x((_g1->x + 200));
            		}
...
HXLINE(  75)		{
HXLINE(  75)			 ::flixel::FlxSprite _g = this->bg;
HXDLIN(  75)			_g->set_alpha((_g->alpha + (elapsed * ((Float)1.5))));
            		}
...
HXLINE(  78)		{
HXLINE(  78)			int _g1 = 0;
HXDLIN(  78)			int _g2 = this->alphabetArray->length;
HXDLIN(  78)			while((_g1 < _g2)){
HXLINE(  78)				_g1 = (_g1 + 1);
HXDLIN(  78)				int i = (_g1 - 1);
HXLINE(  79)				 ::Alphabet spr = this->alphabetArray->__get(i).StaticCast<  ::Alphabet >();
HXLINE(  80)				{
HXLINE(  80)					 ::Alphabet _g = spr;
HXDLIN(  80)					_g->set_alpha((_g->alpha + (elapsed * ((Float)2.5))));
            				}
            			}
            		}
HXLINE(  82)		if ((this->week == -1)) {
HXLINE(  82)			 ::HealthIcon _g = this->icon;
HXDLIN(  82)			_g->set_alpha((_g->alpha + (elapsed * ((Float)2.5))));
            		}
