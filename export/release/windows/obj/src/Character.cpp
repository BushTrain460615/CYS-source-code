...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_269_update,"Character","update",0x0e18944e,"Character.update","Character.hx",269,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_319_dance,"Character","dance",0xde4da48e,"Character.dance","Character.hx",319,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_337_playAnim,"Character","playAnim",0xed2bd3aa,"Character.playAnim","Character.hx",337,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_368_recalculateDanceIdle,"Character","recalculateDanceIdle",0x9672c319,"Character.recalculateDanceIdle","Character.hx",368,0xf073a2d5)
...
HXLINE( 106)				::String path = ::Paths_obj::modFolders(characterPath);
HXLINE( 107)				if (!(::sys::FileSystem_obj::exists(path))) {
HXLINE( 108)					::String file = characterPath;
HXDLIN( 108)					if (::hx::IsNull( file )) {
HXLINE( 108)						file = HX_("",00,00,00,00);
            					}
HXDLIN( 108)					path = (HX_("assets/",4c,2a,dc,36) + file);
            				}
HXLINE( 111)				if (!(::sys::FileSystem_obj::exists(path))) {
HXLINE( 120)					::String file = ((HX_("characters/",45,3c,bf,be) + ::Character_obj::DEFAULT_CHARACTER) + HX_(".json",56,f1,d6,c2));
HXDLIN( 120)					if (::hx::IsNull( file )) {
HXLINE( 120)						file = HX_("",00,00,00,00);
            					}
HXDLIN( 120)					path = (HX_("assets/",4c,2a,dc,36) + file);
            				}
HXLINE( 124)				::String rawJson = ::sys::io::File_obj::getContent(path);
HXLINE( 129)				 ::Dynamic json =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
HXLINE( 130)				::String spriteType = HX_("sparrow",0c,3c,ac,9b);
HXLINE( 135)				::String modTxtToFind = ::Paths_obj::modFolders(( (::String)(((HX_("images/",77,50,74,c1) + json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) + HX_(".txt",02,3f,c0,1e))) ));
HXLINE( 136)				::String txtToFind = ::Paths_obj::getPath(( (::String)(((HX_("images/",77,50,74,c1) + json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) + HX_(".txt",02,3f,c0,1e))) ),HX_("TEXT",ad,94,ba,37),null());
HXLINE( 141)				bool _hx_tmp;
HXDLIN( 141)				bool _hx_tmp1;
HXDLIN( 141)				if (!(::sys::FileSystem_obj::exists(modTxtToFind))) {
HXLINE( 141)					_hx_tmp1 = ::sys::FileSystem_obj::exists(txtToFind);
            				}
            				else {
HXLINE( 141)					_hx_tmp1 = true;
            				}
HXDLIN( 141)				if (!(_hx_tmp1)) {
HXLINE( 141)					_hx_tmp = ::openfl::utils::Assets_obj::exists(txtToFind,null());
            				}
            				else {
HXLINE( 141)					_hx_tmp = true;
            				}
HXDLIN( 141)				if (_hx_tmp) {
HXLINE( 147)					spriteType = HX_("packer",86,57,98,e3);
            				}
HXLINE( 155)				::String modAnimToFind = ::Paths_obj::modFolders(( (::String)(((HX_("images/",77,50,74,c1) + json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) + HX_("/Animation.json",61,fc,54,44))) ));
HXLINE( 156)				::String animToFind = ::Paths_obj::getPath(( (::String)(((HX_("images/",77,50,74,c1) + json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) + HX_("/Animation.json",61,fc,54,44))) ),HX_("TEXT",ad,94,ba,37),null());
HXLINE( 161)				bool _hx_tmp2;
HXDLIN( 161)				bool _hx_tmp3;
HXDLIN( 161)				if (!(::sys::FileSystem_obj::exists(modAnimToFind))) {
HXLINE( 161)					_hx_tmp3 = ::sys::FileSystem_obj::exists(animToFind);
            				}
            				else {
HXLINE( 161)					_hx_tmp3 = true;
            				}
HXDLIN( 161)				if (!(_hx_tmp3)) {
HXLINE( 161)					_hx_tmp2 = ::openfl::utils::Assets_obj::exists(animToFind,null());
            				}
            				else {
HXLINE( 161)					_hx_tmp2 = true;
            				}
HXDLIN( 161)				if (_hx_tmp2) {
HXLINE( 167)					spriteType = HX_("texture",db,c8,e0,9e);
            				}
HXLINE( 174)				::String _hx_switch_0 = spriteType;
            				if (  (_hx_switch_0==HX_("packer",86,57,98,e3)) ){
HXLINE( 177)					::String key = ( (::String)(json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) );
HXDLIN( 177)					::String library = null();
HXDLIN( 177)					 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::returnGraphic(key,null());
HXDLIN( 177)					bool txtExists = false;
HXDLIN( 177)					if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e))))) {
HXLINE( 177)						txtExists = true;
            					}
HXDLIN( 177)					 ::Dynamic _hx_tmp;
HXDLIN( 177)					if (::hx::IsNotNull( imageLoaded )) {
HXLINE( 177)						_hx_tmp = imageLoaded;
            					}
            					else {
HXLINE( 177)						 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(key,library);
HXDLIN( 177)						_hx_tmp = returnAsset;
            					}
HXDLIN( 177)					::String _hx_tmp1;
HXDLIN( 177)					if (txtExists) {
HXLINE( 177)						_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e))));
            					}
            					else {
HXLINE( 177)						_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library);
            					}
HXDLIN( 177)					this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSpriteSheetPacker(_hx_tmp,_hx_tmp1));
HXDLIN( 177)					goto _hx_goto_0;
            				}
            				if (  (_hx_switch_0==HX_("sparrow",0c,3c,ac,9b)) ){
HXLINE( 180)					::String key = ( (::String)(json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) );
HXDLIN( 180)					::String library = null();
HXDLIN( 180)					 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(key,library);
HXDLIN( 180)					 ::flixel::graphics::FlxGraphic graphic = returnAsset;
HXDLIN( 180)					bool xmlExists = false;
HXDLIN( 180)					if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 180)						xmlExists = true;
            					}
HXDLIN( 180)					::String _hx_tmp;
HXDLIN( 180)					if (xmlExists) {
HXLINE( 180)						_hx_tmp = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))));
            					}
            					else {
HXLINE( 180)						_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            					}
HXDLIN( 180)					this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(graphic,_hx_tmp));
HXDLIN( 180)					goto _hx_goto_0;
            				}
            				if (  (_hx_switch_0==HX_("texture",db,c8,e0,9e)) ){
HXLINE( 183)					this->set_frames(::animateatlas::AtlasFrameMaker_obj::construct(( (::String)(json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) ),null()));
HXDLIN( 183)					goto _hx_goto_0;
            				}
            				_hx_goto_0:;
HXLINE( 188)				this->imageFile = ( (::String)(json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) );
HXLINE( 190)				if (::hx::IsNotEq( json->__Field(HX_("scale",8a,ce,ce,78),::hx::paccDynamic),1 )) {
HXLINE( 191)					this->jsonScale = ( (Float)(json->__Field(HX_("scale",8a,ce,ce,78),::hx::paccDynamic)) );
HXLINE( 192)					Float _hx_tmp = this->get_width();
HXDLIN( 192)					this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * this->jsonScale)),null());
HXLINE( 193)					this->updateHitbox();
            				}
HXLINE( 196)				this->positionArray = ( (::Array< Float >)(json->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXLINE( 197)				this->cameraPosition = ( (::Array< Float >)(json->__Field(HX_("camera_position",c3,d4,4a,56),::hx::paccDynamic)) );
HXLINE( 199)				this->healthIcon = ( (::String)(json->__Field(HX_("healthicon",15,8e,6f,17),::hx::paccDynamic)) );
HXLINE( 200)				this->singDuration = ( (Float)(json->__Field(HX_("sing_duration",84,ae,a8,66),::hx::paccDynamic)) );
HXLINE( 201)				this->set_flipX(( (bool)(json->__Field(HX_("flip_x",26,2b,6a,3d),::hx::paccDynamic)) ));
HXLINE( 202)				if (( (bool)(json->__Field(HX_("no_antialiasing",f2,74,67,98),::hx::paccDynamic)) )) {
HXLINE( 203)					this->set_antialiasing(false);
HXLINE( 204)					this->noAntialiasing = true;
            				}
HXLINE( 207)				bool _hx_tmp4;
HXDLIN( 207)				if (::hx::IsNotNull( json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic) )) {
HXLINE( 207)					_hx_tmp4 = (( (::Array< int >)(json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic)) )->length > 2);
            				}
            				else {
HXLINE( 207)					_hx_tmp4 = false;
            				}
HXDLIN( 207)				if (_hx_tmp4) {
HXLINE( 208)					this->healthColorArray = ( (::Array< int >)(json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic)) );
            				}
HXLINE( 210)				this->set_antialiasing(!(this->noAntialiasing));
HXLINE( 211)				if (!(::ClientPrefs_obj::globalAntialiasing)) {
HXLINE( 211)					this->set_antialiasing(false);
            				}
HXLINE( 213)				this->animationsArray = ( (::Array< ::Dynamic>)(json->__Field(HX_("animations",ef,34,1c,83),::hx::paccDynamic)) );
HXLINE( 214)				bool _hx_tmp5;
HXDLIN( 214)				if (::hx::IsNotNull( this->animationsArray )) {
HXLINE( 214)					_hx_tmp5 = (this->animationsArray->length > 0);
            				}
            				else {
...
HXLINE( 215)					int _g = 0;
HXDLIN( 215)					::Array< ::Dynamic> _g1 = this->animationsArray;
HXDLIN( 215)					while((_g < _g1->length)){
HXLINE( 215)						 ::Dynamic anim = _g1->__get(_g);
HXDLIN( 215)						_g = (_g + 1);
HXLINE( 216)						::String animAnim = ( (::String)((HX_("",00,00,00,00) + anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic))) );
HXLINE( 217)						::String animName = ( (::String)((HX_("",00,00,00,00) + anim->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic))) );
HXLINE( 218)						int animFps = ( (int)(anim->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) );
HXLINE( 219)						bool animLoop = ( (bool)(anim->__Field(HX_("loop",64,a6,b7,47),::hx::paccDynamic)) );
HXLINE( 220)						::Array< int > animIndices = ( (::Array< int >)(anim->__Field(HX_("indices",27,47,54,e3),::hx::paccDynamic)) );
HXLINE( 221)						bool _hx_tmp;
HXDLIN( 221)						if (::hx::IsNotNull( animIndices )) {
HXLINE( 221)							_hx_tmp = (animIndices->length > 0);
            						}
            						else {
HXLINE( 221)							_hx_tmp = false;
            						}
HXDLIN( 221)						if (_hx_tmp) {
HXLINE( 222)							this->animation->addByIndices(animAnim,animName,animIndices,HX_("",00,00,00,00),animFps,animLoop,null(),null());
            						}
            						else {
HXLINE( 224)							this->animation->addByPrefix(animAnim,animName,animFps,animLoop,null(),null());
            						}
HXLINE( 227)						bool _hx_tmp1;
HXDLIN( 227)						if (::hx::IsNotNull( anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic) )) {
HXLINE( 227)							_hx_tmp1 = (( (::Array< int >)(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic)) )->length > 1);
            						}
            						else {
HXLINE( 227)							_hx_tmp1 = false;
            						}
HXDLIN( 227)						if (_hx_tmp1) {
HXLINE( 228)							this->addOffset(( (::String)(anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic)) ), ::Dynamic(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic))->__GetItem(0), ::Dynamic(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic))->__GetItem(1));
            						}
            					}
            				}
            				else {
HXLINE( 232)					this->quickAnimAdd(HX_("idle",14,a7,b3,45),HX_("BF idle dance",03,fa,cc,7f));
            				}
            			}
            		}
HXLINE( 236)		this->originalFlipX = this->flipX;
HXLINE( 238)		bool _hx_tmp6;
HXDLIN( 238)		bool _hx_tmp7;
HXDLIN( 238)		bool _hx_tmp8;
HXDLIN( 238)		if (!(this->animOffsets->exists(HX_("singLEFTmiss",d2,2f,9c,b6)))) {
HXLINE( 238)			_hx_tmp8 = this->animOffsets->exists(HX_("singDOWNmiss",ad,e9,88,e4));
            		}
            		else {
HXLINE( 238)			_hx_tmp8 = true;
            		}
HXDLIN( 238)		if (!(_hx_tmp8)) {
HXLINE( 238)			_hx_tmp7 = this->animOffsets->exists(HX_("singUPmiss",66,22,08,8a));
            		}
            		else {
HXLINE( 238)			_hx_tmp7 = true;
            		}
HXDLIN( 238)		if (!(_hx_tmp7)) {
HXLINE( 238)			_hx_tmp6 = this->animOffsets->exists(HX_("singRIGHTmiss",89,cc,65,e3));
            		}
            		else {
HXLINE( 238)			_hx_tmp6 = true;
            		}
HXDLIN( 238)		if (_hx_tmp6) {
HXLINE( 238)			this->hasMissAnimations = true;
            		}
HXLINE( 239)		this->recalculateDanceIdle();
HXLINE( 240)		this->dance();
HXLINE( 242)		if (( (bool)(isPlayer) )) {
HXLINE( 244)			this->set_flipX(!(this->flipX));
            		}
            	}
...
void Character_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_269_update)
HXLINE( 270)		bool _hx_tmp;
HXDLIN( 270)		if (!(this->debugMode)) {
HXLINE( 270)			_hx_tmp = ::hx::IsNotNull( this->animation->_curAnim );
            		}
            		else {
HXLINE( 270)			_hx_tmp = false;
            		}
HXDLIN( 270)		if (_hx_tmp) {
HXLINE( 272)			if ((this->heyTimer > 0)) {
HXLINE( 274)				 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 274)				_hx_tmp->heyTimer = (_hx_tmp->heyTimer - elapsed);
HXLINE( 275)				if ((this->heyTimer <= 0)) {
HXLINE( 277)					bool _hx_tmp;
HXDLIN( 277)					bool _hx_tmp1;
HXDLIN( 277)					if (this->specialAnim) {
HXLINE( 277)						_hx_tmp1 = (this->animation->_curAnim->name == HX_("hey",dc,42,4f,00));
            					}
            					else {
HXLINE( 277)						_hx_tmp1 = false;
            					}
HXDLIN( 277)					if (!(_hx_tmp1)) {
HXLINE( 277)						_hx_tmp = (this->animation->_curAnim->name == HX_("cheer",8d,9a,b6,45));
            					}
            					else {
HXLINE( 277)						_hx_tmp = true;
            					}
HXDLIN( 277)					if (_hx_tmp) {
HXLINE( 279)						this->specialAnim = false;
HXLINE( 280)						this->dance();
            					}
HXLINE( 282)					this->heyTimer = ( (Float)(0) );
            				}
            			}
            			else {
HXLINE( 284)				bool _hx_tmp;
HXDLIN( 284)				if (this->specialAnim) {
HXLINE( 284)					_hx_tmp = this->animation->_curAnim->finished;
            				}
            				else {
...
HXLINE( 287)					this->dance();
            				}
            			}
HXLINE( 290)			if (!(this->isPlayer)) {
HXLINE( 292)				if (::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("sing",4f,96,53,4c))) {
HXLINE( 294)					 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 294)					_hx_tmp->holdTimer = (_hx_tmp->holdTimer + elapsed);
            				}
HXLINE( 297)				if ((this->holdTimer >= ((::Conductor_obj::stepCrochet * ((Float)0.001)) * this->singDuration))) {
HXLINE( 299)					this->dance();
HXLINE( 300)					this->holdTimer = ( (Float)(0) );
            				}
            			}
HXLINE( 304)			bool _hx_tmp;
HXDLIN( 304)			if (this->animation->_curAnim->finished) {
HXLINE( 304)				_hx_tmp = ::hx::IsNotNull( this->animation->_animations->get((this->animation->_curAnim->name + HX_("-loop",11,c1,bf,30))) );
            			}
            			else {
HXLINE( 304)				_hx_tmp = false;
            			}
HXDLIN( 304)			if (_hx_tmp) {
HXLINE( 306)				this->playAnim((this->animation->_curAnim->name + HX_("-loop",11,c1,bf,30)),null(),null(),null());
            			}
            		}
...
void Character_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_319_dance)
HXDLIN( 319)		bool _hx_tmp;
HXDLIN( 319)		if (!(this->debugMode)) {
HXDLIN( 319)			_hx_tmp = !(this->specialAnim);
            		}
            		else {
HXDLIN( 319)			_hx_tmp = false;
            		}
HXDLIN( 319)		if (_hx_tmp) {
HXLINE( 321)			if (this->danceIdle) {
HXLINE( 323)				this->danced = !(this->danced);
HXLINE( 325)				if (this->danced) {
HXLINE( 326)					this->playAnim((HX_("danceRight",a9,7f,a6,91) + this->idleSuffix),null(),null(),null());
            				}
            				else {
HXLINE( 328)					this->playAnim((HX_("danceLeft",da,cc,f9,df) + this->idleSuffix),null(),null(),null());
            				}
            			}
            			else {
HXLINE( 330)				if (::hx::IsNotNull( this->animation->_animations->get((HX_("idle",14,a7,b3,45) + this->idleSuffix)) )) {
HXLINE( 331)					this->playAnim((HX_("idle",14,a7,b3,45) + this->idleSuffix),null(),null(),null());
            				}
            			}
            		}
            	}
...
void Character_obj::playAnim(::String AnimName,::hx::Null< bool >  __o_Force,::hx::Null< bool >  __o_Reversed,::hx::Null< int >  __o_Frame){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_337_playAnim)
HXLINE( 338)		this->specialAnim = false;
HXLINE( 339)		this->animation->play(AnimName,Force,Reversed,Frame);
HXLINE( 341)		::cpp::VirtualArray daOffset = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
HXLINE( 342)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 344)			this->offset->set(daOffset->__get(0),daOffset->__get(1));
            		}
            		else {
HXLINE( 347)			this->offset->set(0,0);
            		}
HXLINE( 349)		if (::StringTools_obj::startsWith(this->curCharacter,HX_("gf",1f,5a,00,00))) {
HXLINE( 351)			if ((AnimName == HX_("singLEFT",d6,39,ef,3b))) {
HXLINE( 353)				this->danced = true;
            			}
            			else {
HXLINE( 355)				if ((AnimName == HX_("singRIGHT",0d,6f,70,ac))) {
HXLINE( 357)					this->danced = false;
            				}
            			}
HXLINE( 360)			bool _hx_tmp;
HXDLIN( 360)			if ((AnimName != HX_("singUP",6a,52,21,b9))) {
HXLINE( 360)				_hx_tmp = (AnimName == HX_("singDOWN",31,2a,ad,36));
            			}
            			else {
HXLINE( 360)				_hx_tmp = true;
            			}
HXDLIN( 360)			if (_hx_tmp) {
HXLINE( 362)				this->danced = !(this->danced);
            			}
            		}
            	}
...
void Character_obj::recalculateDanceIdle(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_368_recalculateDanceIdle)
HXDLIN( 368)		bool _hx_tmp;
HXDLIN( 368)		if (::hx::IsNotNull( this->animation->_animations->get((HX_("danceLeft",da,cc,f9,df) + this->idleSuffix)) )) {
HXDLIN( 368)			_hx_tmp = ::hx::IsNotNull( this->animation->_animations->get((HX_("danceRight",a9,7f,a6,91) + this->idleSuffix)) );
            		}
            		else {
HXDLIN( 368)			_hx_tmp = false;
            		}
HXDLIN( 368)		this->danceIdle = _hx_tmp;
            	}
