...
HX_DEFINE_STACK_FRAME(_hx_pos_f1cc1b74057943ec_1215_new,"InvertShader","new",0xd6e4156d,"InvertShader.new","Shaders.hx",1215,0x469785f0)

void InvertShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f1cc1b74057943ec_1215_new)
...
HXLINE(1216)		super::__construct();
HXLINE(1196)		this->_hx___isGenerated = true;
HXDLIN(1196)		this->_hx___initGL();
            	}
