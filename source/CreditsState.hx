...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['JotaMR',				'jotamr',			'Programmer, Artist/Animator, Cover Maker, Sound Editor',	'https://twitter.com/jotamr_',		'FF3A3A'],
			['Rickylonyolo22',		'ricky',			'Charter', 													'https://twitter.com/jotamr_',		'7143FF'],
			[''],
			[''],
			['Psych Engine Team'],
